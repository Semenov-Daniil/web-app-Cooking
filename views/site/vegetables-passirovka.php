...
<div class="composition-index">
    ...
    <?=Html::a('Экспорт1', ['site/export1', 'title' => 'vegetables_passirovka'], ['class' => 'btn btn-primary']);?>
    <?=Html::a('Экспорт2', ['site/export2', 'title' => 'vegetables_passirovka'], ['class' => 'btn btn-primary']);?>
